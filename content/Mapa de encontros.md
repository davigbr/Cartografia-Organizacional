O mapa de encontros é uma ferramenta da [[Cartografia Organizacional]]para visualizar agenciamentos. Seu objetivo é mapear a "física dos encontros" entre os [[Atuantes]]: pessoas, grupos, infraestrutura e códigos organizacionais. As conexões entre os elementos são denominadas [[Enlaces]]
